window.addEventListener('DOMContentLoaded', async function () {
    ...
    function setCard(el, data, theme) {
        if (!data) {
            el.innerHTML = '<div style="color: red;">Failed to load data</div>';
            return;
        }
        ...
        const stargazers_count = data.stargazers_count !== undefined ? data.stargazers_count : 'N/A';
        const forks = data.forks !== undefined ? data.forks : 'N/A';
        const forked_from = data.fork ? (data.source.full_name || 'Unknown source') : '';
        ...
        el.innerHTML = `
            <div style="flex-direction: column; height: 100%; display: flex;
              ...
              <div style="font-size: 12px; color: ${theme.color}; display: flex; flex: 0;">
                ...
                <div style="display: ${stargazers_count === 0 ? 'none' : 'flex'}; align-items: center; margin-right: 16px;">
